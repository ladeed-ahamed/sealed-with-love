...
function DrawnEnvelope({ onClick }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("group", {
    ...
    children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("mesh", {
        position: [0, 0, 0],
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("planeGeometry", { args: [3, 2] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("meshBasicMaterial", {
            color: "#ffffff",
            side: DoubleSide,
          }),
        ],
      ...
      speaker &&
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
            className: "name-tag text-xl md:text-2xl shadow-[4px_4px_0px_var(--ink)]",
            children: speaker,
          }),
        }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        className:
          "drawn-card p-6 md:p-8 min-h-[120px] md:min-h-[150px] flex flex-col justify-center",
        children: [
          text &&
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", {
              className: "text-2xl md:text-3xl leading-relaxed whitespace-pre-line",
            ...
            children:
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", {
                  className:
                    "play-btn w-12 h-12 md:w-16 md:h-16 flex items-center justify-center bg-white",
                  onClick: (e) => {
                    e.stopPropagation();
                    onNext();
                  },
...
function DrawnCountdown({ targetDateIso }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
    ...
    children: timeUnits.map((unit, idx) =>
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
              className:
                "drawn-card w-16 h-16 md:w-20 md:h-20 flex items-center justify-center bg-white shadow-[2px_2px_0px_var(--ink)]",
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", {
                className: "font-pixel text-4xl md:text-5xl text-blue-accent",
                children: unit.value.toString().padStart(2, "0"),
              }),
            }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", {
              className: "mt-2 font-dialogue text-xs md:text-sm font-bold tracking-widest",
              children: unit.label,
            }),
          ],
        },
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, {
        children:
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, {
            ...
            className:
              "drawn-card px-4 py-2 font-pixel text-lg text-ink shadow-[2px_2px_0px_var(--ink)]",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(motion.button, {
        ...
        children: playing
          ...
          : /* @__PURE__ */ jsxRuntimeExports.jsx("svg", {
              ...
              strokeWidth: "3",
              strokeLinejoin: "round",
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M5 3L19 12L5 21V3Z" }),
            }),
      }),
    ],
  });
...
function RetroCoupleCard() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
    className:
      "flex flex-col md:flex-row items-center justify-center gap-4 md:gap-12 w-full max-w-4xl px-4 pointer-events-auto",
    children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, {
        ...
        className:
          "drawn-card w-full md:w-[280px] bg-white p-4 md:p-6 flex flex-col items-center text-center select-none",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
            className:
              "name-tag mb-3 md:mb-4 text-lg md:text-xl bg-blue-accent shadow-[2px_2px_0px_var(--ink)]",
            children: "GROOM",
          }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
            className:
              "w-20 h-20 md:w-24 md:h-24 rounded-full border-4 border-ink flex items-center justify-center bg-background/50 mb-3 md:mb-4 shadow-[3px_3px_0px_var(--ink)]",
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", {
              className: "font-pixel text-3xl md:text-4xl text-ink",
              children: "🤵",
            }),
          }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", {
            className:
              "font-pixel text-2xl md:text-3xl text-ink mb-1 md:mb-2 uppercase leading-none",
            children: wedding.groom.name,
          }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", {
            className: "font-dialogue text-base md:text-lg leading-relaxed text-ink/80 italic px-2",
            children: wedding.groom.subtitle,
          }),
        ],
      }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
            className:
              "absolute font-pixel text-3xl md:text-5xl animate-bounce text-red-500 filter drop-shadow-[2px_2px_0px_var(--ink)]",
            children: "❤️",
          }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("svg", {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
            className:
              "name-tag mb-3 md:mb-4 text-lg md:text-xl bg-red-400 shadow-[2px_2px_0px_var(--ink)]",
            style: { backgroundColor: "oklch(0.75 0.15 15)" },
            children: "BRIDE",
          }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
            className:
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", {
            className:
              "font-pixel text-2xl md:text-3xl text-ink mb-1 md:mb-2 uppercase leading-none",
            children: wedding.bride.name,
          }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", {
            className: "font-dialogue text-base md:text-lg leading-relaxed text-ink/80 italic px-2",
            children: wedding.bride.subtitle,
          }),
        ],
      }),
    ],
...
function RetroEventCard() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, {
    ...
    className:
      "drawn-card w-full max-w-lg bg-white p-4 md:p-8 flex flex-col items-center text-center select-none shadow-[6px_6px_0px_var(--ink)] pointer-events-auto",
    children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
        className:
          "name-tag mb-4 md:mb-6 text-lg md:text-xl bg-blue-accent shadow-[2px_2px_0px_var(--ink)]",
        children: "CEREMONY DETAILS",
      }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", {
        className: "font-pixel text-2xl md:text-4xl text-ink mb-1 md:mb-2 uppercase leading-none",
        children: wedding.event.culturalName,
      }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
        className: "w-20 md:w-24 h-1 border-t-4 border-ink border-dashed my-2 md:my-4",
      }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        className: "flex flex-col gap-3 md:gap-6 w-full font-dialogue text-ink",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", {
                className:
                  "font-pixel text-base md:text-lg text-blue-accent uppercase block tracking-wider",
                children: "DATE",
              }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", {
                className: "text-xs md:text-sm italic opacity-75",
                children: wedding.event.secondaryDate,
              }),
            ],
          }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", {
                className: "text-xl md:text-2xl font-bold",
                children: wedding.event.venue,
              }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", {
                className:
                  "text-sm md:text-md opacity-80 mt-0.5 md:mt-1 max-w-sm mx-auto leading-relaxed",
                children: wedding.event.address,
              }),
            ],
          }),
        ],
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", {
          className:
            "name-tag hover:scale-105 active:scale-95 transition-transform text-xl md:text-2xl cursor-pointer",
...
const storySequence = [
  ...
  },
  {
    ...
    component: /* @__PURE__ */ jsxRuntimeExports.jsx(DrawnCountdown, {
      targetDateIso: wedding.event.iso,
    }),
  },
  {
    speaker: "BLESSING",
...
function LoaderNotifier({ onLoaded }) {
  reactExports.useEffect(() => {
    onLoaded();
  }, [onLoaded]);
  return null;
...
function Index() {
  ...
  if (errorText) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
      className:
        "fixed inset-0 z-[9999] bg-white p-6 overflow-auto text-red-600 font-mono pointer-events-auto",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", {
          className: "text-xl font-bold mb-4",
          children: "React App Error Detected:",
        }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
    ...
    children: [
      ...
      gameState === "loading" &&
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
          className:
            "absolute inset-0 flex items-center justify-center bg-background z-20 pointer-events-none",
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
            className: "text-center p-8",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", {
                className: "font-pixel text-4xl text-ink uppercase animate-pulse",
                children: "Loading Invitation...",
              }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", {
                className: "font-dialogue text-2xl mt-4",
                children: "Opening the gates of love...",
              }),
            ],
          }),
        }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
        className: `absolute inset-0 z-0 transition-opacity duration-1000 ${gameState === "loading" ? "opacity-100" : "opacity-0 pointer-events-none"}`,
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Canvas, {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(reactExports.Suspense, {
              fallback: null,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(DrawnEnvelope, {
                  onClick: () => setTimeout(() => setGameState("reading"), 100),
                }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Environment, { preset: "city" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderNotifier, {
            ...
            gameState === "reading" &&
              /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
                    className:
                      "absolute inset-0 flex items-center justify-center p-4 pb-[220px] md:pb-4",
                      ...
                      children:
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          motion.div,
                          {
                            ...
                            children: storySequence[currentDialogueIdx].component,
                          },
                          `illustration-${currentDialogueIdx}`,
                        ),
                    }),
                  }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    motion.div,
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogueBox, {
                        speaker: storySequence[currentDialogueIdx].speaker,
                        text: storySequence[currentDialogueIdx].text,
                        onNext: handleNextDialogue,
                      }),
                    },
                    hasComponent ? "dialogue-bottom" : `dialogue-center-${currentDialogueIdx}`,
                  ),
                ],
              }),
            gameState === "finished" &&
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
                className:
                  "absolute inset-0 flex flex-col items-center justify-center text-center px-6 pointer-events-auto",
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                  className: "drawn-card p-10 flex flex-col gap-6 items-center",
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", {
                      className: "font-pixel text-4xl text-blue-accent uppercase",
                      children: "End of Chapter",
                    }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", {
                      className: "font-dialogue text-2xl",
                      children: wedding.footerTagline,
                    }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("button", {
                      className:
                        "name-tag mt-4 hover:scale-105 active:scale-95 transition-transform cursor-pointer",
                      onClick: () => {
