                ...
                transaction: function transaction(func2) {
                  ...
                  func2({
                    setUniform: function setUniform(type, name2) {
                      ...
                      var uniformLoc =
                        uniforms[name2] ||
                        (uniforms[name2] = gl.getUniformLocation(program, name2));
                    ...
                    setAttribute: function setAttribute(
                      ...
                      if (isWebGL2) {
                        ...
                        getExtension("ANGLE_instanced_arrays").vertexAttribDivisorANGLE(
                          attr.loc,
                          instancingDivisor,
                        );
                      }
