...
import {
  ...
  g as Vector2,
  C as Color,
  l as CubeReflectionMapping,
  E as EquirectangularReflectionMapping,
  m as CubeTextureLoader,
  S as Scene,
  n as WebGLCubeRenderTarget,
  H as HalfFloatType,
} from "./three.mjs";
import {
  L as LineSegments2,
  a as Line2,
  b as LineMaterial,
  c as LineSegmentsGeometry,
  d as LineGeometry,
  R as RGBELoader,
  E as EXRLoader,
  G as GroundProjectedEnv,
} from "./three-stdlib.mjs";
import {
  u as useThree,
  a as useLoader,
  e as extend,
...
const Line = /* @__PURE__ */ reactExports.forwardRef(function Line3(
  { points, color = 16777215, vertexColors, linewidth, lineWidth, segments, dashed, ...rest },
  ref,
) {
  var _vertexColors$, _ref;
  const size = useThree((state) => state.size);
  const line2 = reactExports.useMemo(
    () => (segments ? new LineSegments2() : new Line2()),
    [segments],
  );
  const [lineMaterial] = reactExports.useState(() => new LineMaterial());
  const itemSize =
    (vertexColors == null || (_vertexColors$ = vertexColors[0]) == null
      ? void 0
      : _vertexColors$.length) === 4
      ? 4
      : 3;
      ...
      _extends(
        {
          ...
          linewidth:
            (_ref = linewidth !== null && linewidth !== void 0 ? linewidth : lineWidth) !== null &&
            _ref !== void 0
              ? _ref
              : 1,
          dashed,
...
function useEnvironment({
  ...
  texture.colorSpace =
    colorSpace !== null && colorSpace !== void 0 ? colorSpace : isCubemap ? "srgb" : "srgb-linear";
  return texture;
}
...
function getExtension(files) {
  ...
  const isGainmap =
    isArray(files) && files.length === 3 && files.some((file) => file.endsWith("json"));
      ...
      : firstEntry.startsWith("data:application/exr")
        ...
        : firstEntry.startsWith("data:application/hdr")
          ...
          : firstEntry.startsWith("data:image/jpeg")
            ? "jpg"
            : (_firstEntry$split$pop = firstEntry.split(".").pop()) == null ||
                (_firstEntry$split$pop = _firstEntry$split$pop.split("?")) == null ||
                (_firstEntry$split$pop = _firstEntry$split$pop.shift()) == null
              ? void 0
    ...
    backgroundRotation:
      (_target$backgroundRot =
        ...
        _target$backgroundRot2.clone == null
          ? void 0
          : _target$backgroundRot2.clone()) !== null && _target$backgroundRot !== void 0
        ? _target$backgroundRot
        : [0, 0, 0],
    // @ts-ignore
    ...
    environmentRotation:
      (_target$environmentRo =
        ...
        _target$environmentRo2.clone == null
          ? void 0
          : _target$environmentRo2.clone()) !== null && _target$environmentRo !== void 0
        ? _target$environmentRo
        : [0, 0, 0],
  };
  ...
  return /* @__PURE__ */ reactExports.createElement(
    ...
    createPortal(
      /* @__PURE__ */ reactExports.createElement(
        ...
        null,
        children,
        /* @__PURE__ */ reactExports.createElement("cubeCamera", {
          ref: camera,
          args: [near, far, fbo],
        }),
        files || preset
          ? /* @__PURE__ */ reactExports.createElement(EnvironmentCube, {
              background: true,
              files,
              preset,
              path,
          ...
          : map
            ? /* @__PURE__ */ reactExports.createElement(EnvironmentMap, {
                background: true,
                map,
                extensions,
              })
...
function EnvironmentGround(props) {
  ...
  const scale =
    (_scale = (_props$ground3 = props.ground) == null ? void 0 : _props$ground3.scale) !== null &&
    _scale !== void 0
      ? _scale
      : 1e3;
  return /* @__PURE__ */ reactExports.createElement(
...
function Environment(props) {
  return props.ground
    ? /* @__PURE__ */ reactExports.createElement(EnvironmentGround, props)
    : props.map
      ? /* @__PURE__ */ reactExports.createElement(EnvironmentMap, props)
      : props.children
        ? /* @__PURE__ */ reactExports.createElement(EnvironmentPortal, props)
        : /* @__PURE__ */ reactExports.createElement(EnvironmentCube, props);
}
export { Environment as E, Line as L, Text as T };
